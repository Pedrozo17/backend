...
class TareasAPIView(APIView):
    ...
    # GET → Trae solo las tareas del usuario autenticado
    def get(self, request, tarea_id=None):
        ...
        limit = int(request.query_params.get('limit', 10))#el 10 es el limite por defecto
        last_doc_id = request.query_params.get('last_doc_id')

        #definir las consultas dependiendo del rol
    ...
    def put(self, request, tarea_id=None):
        ...
        try:
            ...
            if serializer.is_valid():
                ...
                return Response(
                    {
                        "mensaje": f"Tarea {tarea_id} actualizada exitosamente",
